...
export function importModalFirstPage(){
    return(
        ...
        <button type="submit" class="w-fit text-gray-700 inline-flex items-center bg-white hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-blue-800">
              <svg class="me-1 -ms-1 w-5 h-5" fill="black" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"/></svg>
              Загрузить
            </button>
        `
    )
