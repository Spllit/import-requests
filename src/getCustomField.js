export default function getCustomField({formId, customFieldId}){
    return(
        ...
        //     <input type="text" name="customFieldApi" placeholder="название поля в API" class=" w-50 mr-3 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
        //     <input type="text" name="customFieldValue" placeholder="значение" class=" w-80 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
        // </div>
        // `
        ` 
